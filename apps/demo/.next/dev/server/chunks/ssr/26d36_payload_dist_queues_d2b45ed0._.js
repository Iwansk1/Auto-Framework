module.exports = [
"[project]/Jaar4/automotive-framework/node_modules/payload/dist/queues/config/global.js [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/Jaar4/automotive-framework/node_modules/payload/dist/queues/utilities/getCurrentDate.js [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/Jaar4/automotive-framework/node_modules/payload/dist/queues/operations/handleSchedules/defaultAfterSchedule.js [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const defaultAfterSchedule = async ({ jobStats, queueable, req })=>{
    ...
    if (queueable.taskConfig) {
        ...
        (queueConfig.tasks ??= {})[queueable.taskConfig.slug] = {
            lastScheduledRun: (0, __TURBOPACK__imported__module__$5b$project$5d2f$Jaar4$2f$automotive$2d$framework$2f$node_modules$2f$payload$2f$dist$2f$queues$2f$utilities$2f$getCurrentDate$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["getCurrentDate"])().toISOString()
        };
    ...
    if (jobStats) {
        await req.payload.db.updateGlobal({
            slug: __TURBOPACK__imported__module__$5b$project$5d2f$Jaar4$2f$automotive$2d$framework$2f$node_modules$2f$payload$2f$dist$2f$queues$2f$config$2f$global$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["jobStatsGlobalSlug"],
            data: {
                ...jobStats || {},
                stats: {
                    ...jobStats?.stats || {},
        ...
        await req.payload.db.createGlobal({
            slug: __TURBOPACK__imported__module__$5b$project$5d2f$Jaar4$2f$automotive$2d$framework$2f$node_modules$2f$payload$2f$dist$2f$queues$2f$config$2f$global$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["jobStatsGlobalSlug"],
            data: {
                createdAt: (0, __TURBOPACK__imported__module__$5b$project$5d2f$Jaar4$2f$automotive$2d$framework$2f$node_modules$2f$payload$2f$dist$2f$queues$2f$utilities$2f$getCurrentDate$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["getCurrentDate"])().toISOString(),
                stats: {
                    scheduledRuns: {
                        queues: {
                            [queueable.scheduleConfig.queue]: queueConfig
...
"[project]/Jaar4/automotive-framework/node_modules/payload/dist/queues/operations/handleSchedules/countRunnableOrActiveJobsForQueue.js [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/Jaar4/automotive-framework/node_modules/payload/dist/queues/operations/handleSchedules/defaultBeforeSchedule.js [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/Jaar4/automotive-framework/node_modules/payload/dist/queues/operations/handleSchedules/getQueuesWithSchedules.js [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/Jaar4/automotive-framework/node_modules/payload/dist/queues/operations/handleSchedules/index.js [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function handleSchedules({ allQueues = false, queue: _queue, req }) {
    ...
    const queuesWithSchedules = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Jaar4$2f$automotive$2d$framework$2f$node_modules$2f$payload$2f$dist$2f$queues$2f$operations$2f$handleSchedules$2f$getQueuesWithSchedules$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["getQueuesWithSchedules"])({
        jobsConfig
    });
...
function checkQueueableTimeConstraints({ queue, scheduleConfig, stats, taskConfig, workflowConfig }) {
    ...
    const nextRun = new __TURBOPACK__imported__module__$5b$project$5d2f$Jaar4$2f$automotive$2d$framework$2f$node_modules$2f$croner$2f$dist$2f$croner$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["Cron"](scheduleConfig.cron).nextRun(lastScheduledRun ?? undefined);
    if (!nextRun) {
        return false;
    }
    return {
...
async function scheduleQueueable({ queueable, req, stats }) {
    ...
    try {
        const beforeScheduleResult = await (beforeScheduleFn ?? __TURBOPACK__imported__module__$5b$project$5d2f$Jaar4$2f$automotive$2d$framework$2f$node_modules$2f$payload$2f$dist$2f$queues$2f$operations$2f$handleSchedules$2f$defaultBeforeSchedule$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["defaultBeforeSchedule"])({
            // @ts-expect-error we know defaultBeforeSchedule will never call itself => pass null
            defaultBeforeSchedule: beforeScheduleFn ? __TURBOPACK__imported__module__$5b$project$5d2f$Jaar4$2f$automotive$2d$framework$2f$node_modules$2f$payload$2f$dist$2f$queues$2f$operations$2f$handleSchedules$2f$defaultBeforeSchedule$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["defaultBeforeSchedule"] : null,
            jobStats: stats,
            queueable,
            req
        });
        if (!beforeScheduleResult.shouldSchedule) {
            await (afterScheduleFN ?? __TURBOPACK__imported__module__$5b$project$5d2f$Jaar4$2f$automotive$2d$framework$2f$node_modules$2f$payload$2f$dist$2f$queues$2f$operations$2f$handleSchedules$2f$defaultAfterSchedule$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["defaultAfterSchedule"])({
                // @ts-expect-error we know defaultAfterchedule will never call itself => pass null
                defaultAfterSchedule: afterScheduleFN ? __TURBOPACK__imported__module__$5b$project$5d2f$Jaar4$2f$automotive$2d$framework$2f$node_modules$2f$payload$2f$dist$2f$queues$2f$operations$2f$handleSchedules$2f$defaultAfterSchedule$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["defaultAfterSchedule"] : null,
                jobStats: stats,
                queueable,
                req,
                status: 'skipped'
...
"[project]/Jaar4/automotive-framework/node_modules/payload/dist/queues/errors/index.js [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/Jaar4/automotive-framework/node_modules/payload/dist/queues/utilities/updateJob.js [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function updateJobs({ id, data, depth, disableTransaction, limit: limitArg, req, returning, sort, where: whereArg }) {
    ...
    return updatedJobs.map((updatedJob)=>{
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$Jaar4$2f$automotive$2d$framework$2f$node_modules$2f$payload$2f$dist$2f$queues$2f$config$2f$collection$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["jobAfterRead"])({
...
"[project]/Jaar4/automotive-framework/node_modules/payload/dist/queues/operations/runJobs/runJob/getUpdateJobFunction.js [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$Jaar4$2f$automotive$2d$framework$2f$node_modules$2f$payload$2f$dist$2f$queues$2f$errors$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/Jaar4/automotive-framework/node_modules/payload/dist/queues/errors/index.js [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$Jaar4$2f$automotive$2d$framework$2f$node_modules$2f$payload$2f$dist$2f$queues$2f$utilities$2f$updateJob$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/Jaar4/automotive-framework/node_modules/payload/dist/queues/utilities/updateJob.js [app-rsc] (ecmascript)");
;
;
function getUpdateJobFunction(job, req) {
    return async (jobData)=>{
        const updatedJob = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Jaar4$2f$automotive$2d$framework$2f$node_modules$2f$payload$2f$dist$2f$queues$2f$utilities$2f$updateJob$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["updateJob"])({
            id: job.id,
            data: jobData,
        ...
        if (updatedJob?.error?.cancelled) {
            throw new __TURBOPACK__imported__module__$5b$project$5d2f$Jaar4$2f$automotive$2d$framework$2f$node_modules$2f$payload$2f$dist$2f$queues$2f$errors$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["JobCancelledError"](`Job ${job.id} was cancelled`);
        }
        return updatedJob;
    };
} //# sourceMappingURL=getUpdateJobFunction.js.map
}),
"[project]/Jaar4/automotive-framework/node_modules/payload/dist/queues/operations/runJobs/runJob/importHandlerPath.js [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function importHandlerPath(path) {
    ...
    let runnerModule;
    try {
        runnerModule = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Jaar4$2f$automotive$2d$framework$2f$node_modules$2f$payload$2f$dist$2f$utilities$2f$dynamicImport$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["dynamicImport"])(runnerPath);
    } catch (e) {
...
"[project]/Jaar4/automotive-framework/node_modules/payload/dist/queues/errors/calculateBackoffWaitUntil.js [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function calculateBackoffWaitUntil({ retriesConfig, totalTried }) {
    let waitUntil = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Jaar4$2f$automotive$2d$framework$2f$node_modules$2f$payload$2f$dist$2f$queues$2f$utilities$2f$getCurrentDate$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["getCurrentDate"])();
    if (typeof retriesConfig === 'object') {
        if (retriesConfig.backoff) {
            if (retriesConfig.backoff.type === 'fixed') {
                waitUntil = retriesConfig.backoff.delay ? new Date((0, __TURBOPACK__imported__module__$5b$project$5d2f$Jaar4$2f$automotive$2d$framework$2f$node_modules$2f$payload$2f$dist$2f$queues$2f$utilities$2f$getCurrentDate$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["getCurrentDate"])().getTime() + retriesConfig.backoff.delay) : (0, __TURBOPACK__imported__module__$5b$project$5d2f$Jaar4$2f$automotive$2d$framework$2f$node_modules$2f$payload$2f$dist$2f$queues$2f$utilities$2f$getCurrentDate$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["getCurrentDate"])();
                ...
                waitUntil = new Date((0, __TURBOPACK__imported__module__$5b$project$5d2f$Jaar4$2f$automotive$2d$framework$2f$node_modules$2f$payload$2f$dist$2f$queues$2f$utilities$2f$getCurrentDate$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["getCurrentDate"])().getTime() + Math.pow(2, totalTried) * delay);
            }
        }
    }
    /*
...
"[project]/Jaar4/automotive-framework/node_modules/payload/dist/queues/errors/getWorkflowRetryBehavior.js [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function getWorkflowRetryBehavior({ job, retriesConfig }) {
    ...
    const waitUntil = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Jaar4$2f$automotive$2d$framework$2f$node_modules$2f$payload$2f$dist$2f$queues$2f$errors$2f$calculateBackoffWaitUntil$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["calculateBackoffWaitUntil"])({
        retriesConfig,
...
"[project]/Jaar4/automotive-framework/node_modules/payload/dist/queues/errors/handleTaskError.js [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function handleTaskError({ error, req, silent = false, updateJob }) {
    ...
    const currentDate = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Jaar4$2f$automotive$2d$framework$2f$node_modules$2f$payload$2f$dist$2f$queues$2f$utilities$2f$getCurrentDate$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["getCurrentDate"])();
    if (job.waitUntil) {
   ...
   */ // First set task waitUntil - if the workflow waitUntil is later, it will be updated later
    const taskWaitUntil = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Jaar4$2f$automotive$2d$framework$2f$node_modules$2f$payload$2f$dist$2f$queues$2f$errors$2f$calculateBackoffWaitUntil$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["calculateBackoffWaitUntil"])({
        retriesConfig,
    ...
    const { hasFinalError, maxWorkflowRetries, waitUntil } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Jaar4$2f$automotive$2d$framework$2f$node_modules$2f$payload$2f$dist$2f$queues$2f$errors$2f$getWorkflowRetryBehavior$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["getWorkflowRetryBehavior"])({
        job,
...
"[project]/Jaar4/automotive-framework/node_modules/payload/dist/queues/errors/handleWorkflowError.js [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function handleWorkflowError({ error, req, silent = false, updateJob }) {
    ...
    if (!hasFinalError) {
        if (job.waitUntil) {
            // Check if waitUntil is in the past
            const waitUntil = new Date(job.waitUntil);
            if (waitUntil < (0, __TURBOPACK__imported__module__$5b$project$5d2f$Jaar4$2f$automotive$2d$framework$2f$node_modules$2f$payload$2f$dist$2f$queues$2f$utilities$2f$getCurrentDate$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["getCurrentDate"])()) {
                // Outdated waitUntil, remove it
                delete job.waitUntil;
            }
        }
...
"[project]/Jaar4/automotive-framework/node_modules/payload/dist/queues/operations/runJobs/runJob/getRunTaskFunction.js [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const getRunTaskFunction = (job, workflowConfig, req, isInline, updateJob, parent)=>{
    ...
    const runTask = (taskSlug)=>async (taskID, { input, retries, task })=>{
            const executedAt = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Jaar4$2f$automotive$2d$framework$2f$node_modules$2f$payload$2f$dist$2f$queues$2f$utilities$2f$getCurrentDate$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["getCurrentDate"])();
            let taskConfig;
            if (!isInline) {
            ...
            const runner = isInline ? task : await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Jaar4$2f$automotive$2d$framework$2f$node_modules$2f$payload$2f$dist$2f$queues$2f$operations$2f$runJobs$2f$runJob$2f$importHandlerPath$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["getTaskHandlerFromConfig"])(taskConfig);
            if (!runner || typeof runner !== 'function') {
                throw new __TURBOPACK__imported__module__$5b$project$5d2f$Jaar4$2f$automotive$2d$framework$2f$node_modules$2f$payload$2f$dist$2f$queues$2f$errors$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["TaskError"]({
                    executedAt,
                    input,
                    job,
            ...
            try {
                ...
                if (err instanceof __TURBOPACK__imported__module__$5b$project$5d2f$Jaar4$2f$automotive$2d$framework$2f$node_modules$2f$payload$2f$dist$2f$queues$2f$errors$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["JobCancelledError"]) {
            ...
            const newLogItem = {
                id: new ObjectId().toHexString(),
                completedAt: (0, __TURBOPACK__imported__module__$5b$project$5d2f$Jaar4$2f$automotive$2d$framework$2f$node_modules$2f$payload$2f$dist$2f$queues$2f$utilities$2f$getCurrentDate$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["getCurrentDate"])().toISOString(),
                executedAt: executedAt.toISOString(),
                input,
                output,
...
"[project]/Jaar4/automotive-framework/node_modules/payload/dist/queues/operations/runJobs/runJob/index.js [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const runJob = async ({ job, req, silent, updateJob, workflowConfig, workflowHandler })=>{
    ...
    try {
        await workflowHandler({
            inlineTask: (0, __TURBOPACK__imported__module__$5b$project$5d2f$Jaar4$2f$automotive$2d$framework$2f$node_modules$2f$payload$2f$dist$2f$queues$2f$operations$2f$runJobs$2f$runJob$2f$getRunTaskFunction$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["getRunTaskFunction"])(job, workflowConfig, req, true, updateJob),
            job,
            req,
            tasks: (0, __TURBOPACK__imported__module__$5b$project$5d2f$Jaar4$2f$automotive$2d$framework$2f$node_modules$2f$payload$2f$dist$2f$queues$2f$operations$2f$runJobs$2f$runJob$2f$getRunTaskFunction$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["getRunTaskFunction"])(job, workflowConfig, req, false, updateJob)
        });
    } catch (error) {
        if (error instanceof __TURBOPACK__imported__module__$5b$project$5d2f$Jaar4$2f$automotive$2d$framework$2f$node_modules$2f$payload$2f$dist$2f$queues$2f$errors$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["JobCancelledError"]) {
            throw error // Job cancellation is handled in a top-level error handler, as higher up code may themselves throw this error
            ;
        }
        if (error instanceof __TURBOPACK__imported__module__$5b$project$5d2f$Jaar4$2f$automotive$2d$framework$2f$node_modules$2f$payload$2f$dist$2f$queues$2f$errors$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["TaskError"]) {
            const { hasFinalError } = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Jaar4$2f$automotive$2d$framework$2f$node_modules$2f$payload$2f$dist$2f$queues$2f$errors$2f$handleTaskError$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["handleTaskError"])({
                error,
                req,
                silent,
                updateJob
        ...
        const { hasFinalError } = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Jaar4$2f$automotive$2d$framework$2f$node_modules$2f$payload$2f$dist$2f$queues$2f$errors$2f$handleWorkflowError$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["handleWorkflowError"])({
            error: error instanceof __TURBOPACK__imported__module__$5b$project$5d2f$Jaar4$2f$automotive$2d$framework$2f$node_modules$2f$payload$2f$dist$2f$queues$2f$errors$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["WorkflowError"] ? error : new __TURBOPACK__imported__module__$5b$project$5d2f$Jaar4$2f$automotive$2d$framework$2f$node_modules$2f$payload$2f$dist$2f$queues$2f$errors$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["WorkflowError"]({
                job,
...
"[project]/Jaar4/automotive-framework/node_modules/payload/dist/queues/operations/runJobs/runJSONJob/index.js [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/Jaar4/automotive-framework/node_modules/payload/dist/queues/operations/runJobs/index.js [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const runJobs = async (args)=>{
    ...
    const and = [
        ...
        },
        {
            or: [
                ...
                {
                    waitUntil: {
                        less_than: (0, __TURBOPACK__imported__module__$5b$project$5d2f$Jaar4$2f$automotive$2d$framework$2f$node_modules$2f$payload$2f$dist$2f$queues$2f$utilities$2f$getCurrentDate$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["getCurrentDate"])().toISOString()
                    }
                }
            ]
        }
    ...
    if (id) {
        // Only one job to run
        const job = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Jaar4$2f$automotive$2d$framework$2f$node_modules$2f$payload$2f$dist$2f$queues$2f$utilities$2f$updateJob$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["updateJob"])({
            id,
            data: {
                processing: true
            },
        ...
        let defaultProcessingOrder = payload.collections[__TURBOPACK__imported__module__$5b$project$5d2f$Jaar4$2f$automotive$2d$framework$2f$node_modules$2f$payload$2f$dist$2f$queues$2f$config$2f$collection$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["jobsCollectionSlug"]]?.config.defaultSort ?? 'createdAt';
        ...
        const updatedDocs = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Jaar4$2f$automotive$2d$framework$2f$node_modules$2f$payload$2f$dist$2f$queues$2f$utilities$2f$updateJob$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["updateJobs"])({
            data: {
                processing: true
            },
            depth: jobsConfig.depth,
    ...
    if (jobsConfig.enableConcurrencyControl) {
        ...
        if (jobsToRelease.length > 0) {
            ...
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Jaar4$2f$automotive$2d$framework$2f$node_modules$2f$payload$2f$dist$2f$queues$2f$utilities$2f$updateJob$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["updateJobs"])({
                data: {
                    processing: false
                },
                disableTransaction: true,
   ...
   */ const { existingJobs, newJobs } = jobs.reduce((acc, job)=>{
    ...
    const runSingleJob = async (job)=>{
        ...
        const jobReq = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Jaar4$2f$automotive$2d$framework$2f$node_modules$2f$payload$2f$dist$2f$utilities$2f$isolateObjectProperty$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["isolateObjectProperty"])(req, 'transactionID');
        ...
        try {
            const updateJob = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Jaar4$2f$automotive$2d$framework$2f$node_modules$2f$payload$2f$dist$2f$queues$2f$operations$2f$runJobs$2f$runJob$2f$getUpdateJobFunction$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["getUpdateJobFunction"])(job, jobReq);
            ...
            if (typeof workflowConfig.handler === 'function' || typeof workflowConfig.handler === 'object' && Array.isArray(workflowConfig.handler)) {
                ...
                workflowHandler = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Jaar4$2f$automotive$2d$framework$2f$node_modules$2f$payload$2f$dist$2f$queues$2f$operations$2f$runJobs$2f$runJob$2f$importHandlerPath$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["importHandlerPath"])(workflowConfig.handler);
                if (!workflowHandler) {
                    const jobLabel = job.workflowSlug || `Task: ${job.taskSlug}`;
            ...
            if (typeof workflowHandler === 'function') {
                const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Jaar4$2f$automotive$2d$framework$2f$node_modules$2f$payload$2f$dist$2f$queues$2f$operations$2f$runJobs$2f$runJob$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["runJob"])({
                    job,
                    req: jobReq,
                    silent,
                    updateJob,
                ...
                const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Jaar4$2f$automotive$2d$framework$2f$node_modules$2f$payload$2f$dist$2f$queues$2f$operations$2f$runJobs$2f$runJSONJob$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["runJSONJob"])({
                    job,
                    req: jobReq,
                    silent,
                    updateJob,
            ...
            if (error instanceof __TURBOPACK__imported__module__$5b$project$5d2f$Jaar4$2f$automotive$2d$framework$2f$node_modules$2f$payload$2f$dist$2f$queues$2f$errors$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["JobCancelledError"]) {
                if (!job.error?.cancelled || !job.hasError || job.processing || job.completedAt || job.waitUntil) {
                    ...
                    await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Jaar4$2f$automotive$2d$framework$2f$node_modules$2f$payload$2f$dist$2f$queues$2f$utilities$2f$updateJob$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["updateJob"])({
                        id: job.id,
                        data: {
                            completedAt: null,
                            error: {
...
"[project]/Jaar4/automotive-framework/node_modules/payload/dist/queues/endpoints/run.js [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const runJobsEndpoint = {
    handler: async (req)=>{
        ...
        let remainingJobsFromQueried = 0;
        try {
            const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Jaar4$2f$automotive$2d$framework$2f$node_modules$2f$payload$2f$dist$2f$queues$2f$operations$2f$runJobs$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["runJobs"])(runJobsArgs);
...
"[project]/Jaar4/automotive-framework/node_modules/payload/dist/queues/endpoints/handleSchedules.js [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$Jaar4$2f$automotive$2d$framework$2f$node_modules$2f$payload$2f$dist$2f$queues$2f$endpoints$2f$run$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/Jaar4/automotive-framework/node_modules/payload/dist/queues/endpoints/run.js [app-rsc] (ecmascript)");
;
;
const handleSchedulesJobsEndpoint = {
    handler: async (req)=>{
        const jobsConfig = req.payload.config.jobs;
        if (!(0, __TURBOPACK__imported__module__$5b$project$5d2f$Jaar4$2f$automotive$2d$framework$2f$node_modules$2f$payload$2f$dist$2f$queues$2f$endpoints$2f$run$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["configHasJobs"])(jobsConfig)) {
            return Response.json({
        ...
        const runAllQueues = allQueues && !(typeof allQueues === 'string' && allQueues === 'false');
        const { errored, queued, skipped } = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Jaar4$2f$automotive$2d$framework$2f$node_modules$2f$payload$2f$dist$2f$queues$2f$operations$2f$handleSchedules$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["handleSchedules"])({
            allQueues: runAllQueues,
            queue,
            req
        });
...
"[project]/Jaar4/automotive-framework/node_modules/payload/dist/queues/utilities/getJobTaskStatus.js [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/Jaar4/automotive-framework/node_modules/payload/dist/queues/config/collection.js [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const getDefaultJobsCollection = (jobsConfig)=>{
    ...
    const jobsCollection = {
        ...
        endpoints: [
            __TURBOPACK__imported__module__$5b$project$5d2f$Jaar4$2f$automotive$2d$framework$2f$node_modules$2f$payload$2f$dist$2f$queues$2f$endpoints$2f$run$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["runJobsEndpoint"],
            __TURBOPACK__imported__module__$5b$project$5d2f$Jaar4$2f$automotive$2d$framework$2f$node_modules$2f$payload$2f$dist$2f$queues$2f$endpoints$2f$handleSchedules$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["handleSchedulesJobsEndpoint"]
        ],
        fields: [
            {
                name: 'input',
...
function jobAfterRead({ config, doc }) {
    doc.taskStatus = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Jaar4$2f$automotive$2d$framework$2f$node_modules$2f$payload$2f$dist$2f$queues$2f$utilities$2f$getJobTaskStatus$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["getJobTaskStatus"])({
        jobLog: doc.log || []
    });
    doc.input = doc.input || {};
...
"[project]/Jaar4/automotive-framework/node_modules/payload/dist/queues/config/generateJobsJSONSchemas.js [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
    ...
    if (jobsConfig?.tasks?.length) {
        for (const task of jobsConfig.tasks){
            ...
            if (task?.inputSchema?.length) {
                const inputJsonSchema = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Jaar4$2f$automotive$2d$framework$2f$node_modules$2f$payload$2f$dist$2f$utilities$2f$configToJSONSchema$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["fieldsToJSONSchema"])(collectionIDFieldTypes, (0, __TURBOPACK__imported__module__$5b$project$5d2f$Jaar4$2f$automotive$2d$framework$2f$node_modules$2f$payload$2f$dist$2f$utilities$2f$flattenAllFields$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["flattenAllFields"])({
            ...
            if (task?.outputSchema?.length) {
                const outputJsonSchema = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Jaar4$2f$automotive$2d$framework$2f$node_modules$2f$payload$2f$dist$2f$utilities$2f$configToJSONSchema$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["fieldsToJSONSchema"])(collectionIDFieldTypes, (0, __TURBOPACK__imported__module__$5b$project$5d2f$Jaar4$2f$automotive$2d$framework$2f$node_modules$2f$payload$2f$dist$2f$utilities$2f$flattenAllFields$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["flattenAllFields"])({
...
"[project]/Jaar4/automotive-framework/node_modules/payload/dist/queues/localAPI.js [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const getJobsLocalAPI = (payload)=>({
        handleSchedules: async (args)=>{
            const newReq = args?.req ?? await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Jaar4$2f$automotive$2d$framework$2f$node_modules$2f$payload$2f$dist$2f$utilities$2f$createLocalReq$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["createLocalReq"])({}, payload);
            return await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Jaar4$2f$automotive$2d$framework$2f$node_modules$2f$payload$2f$dist$2f$queues$2f$operations$2f$handleSchedules$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["handleSchedules"])({
        ...
        queue: async (args)=>{
            ...
            const req = args.req ?? await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Jaar4$2f$automotive$2d$framework$2f$node_modules$2f$payload$2f$dist$2f$utilities$2f$createLocalReq$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["createLocalReq"])({}, payload);
            if (!overrideAccess) {
                /**
       ...
       */ const accessFn = payload.config.jobs?.access?.queue ?? (()=>true);
        ...
        run: async (args)=>{
            const newReq = args?.req ?? await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Jaar4$2f$automotive$2d$framework$2f$node_modules$2f$payload$2f$dist$2f$utilities$2f$createLocalReq$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["createLocalReq"])({}, payload);
            return await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Jaar4$2f$automotive$2d$framework$2f$node_modules$2f$payload$2f$dist$2f$queues$2f$operations$2f$runJobs$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["runJobs"])({
                allQueues: args?.allQueues,
                limit: args?.limit,
...
//# sourceMappingURL=26d36_payload_dist_queues_d2b45ed0._.js.map